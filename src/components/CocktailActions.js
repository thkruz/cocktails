...
const CocktailActions = ({ updateFavourites, classes, cocktail, favourites, hideLabelOnXS = false }) => {
  return (
    <>
      <Button
      ...
      >
        {favourites.includes(cocktail.slug) ? <UnFavouriteIcon /> : <FavouriteIcon />}
        <ConditionalHidden hideOnXS={hideLabelOnXS}>Favourite</ConditionalHidden>
      </Button>
      <Button
        component={Link}
      ...
      >
        <ReadMoreIcon />
        <ConditionalHidden hideOnXS={hideLabelOnXS}>Learn More</ConditionalHidden>
      </Button>
    </>
  );
};
