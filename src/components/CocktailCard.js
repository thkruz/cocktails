...
const CocktailCard = ({ cocktail, classes, allGlasses, favourite, favourites, updateFavourites }) => {
  if (!cocktail) return null;

  return (
    <Card className={classes.card}>
      <CardActionArea className={classes.cardMain} component={Link} to={`/cocktails/${cocktail.slug}`}>
        <CardHeader
