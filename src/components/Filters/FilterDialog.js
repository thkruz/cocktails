...
import { Dialog, DialogTitle, DialogActions, IconButton, Button } from '@material-ui/core';
...
const FilterDialog = ({ classes, closeFilterDialog, filterOptions: { activeDialog } }) => {
  ...
  return (
    <Dialog open={!!activeDialog} fullWidth={true} onClose={handleCloseDialog} aria-labelledby="simple-dialog-title">
      <>
