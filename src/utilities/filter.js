 ...
 * @param {*} filter
 */
export const applyFilter = (cocktails, filter) =>
  cocktails.filter(cocktail => rules[filter.rule.toString()](cocktail, filter));
 ...
 * @param {*} filters
 */
export const applyFilters = (cocktails, filters = []) => {
...
export const filtersFromUserOptions = state => {
